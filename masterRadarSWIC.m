...
beam1 = 78.28; % Pen beam angle for PXY1
beam2 = 178.2; % Per beam angle for PXY2
...
Comment1='Swell Wave Inversion model RadarSWIC as described in Alattabi et al (2021)';
