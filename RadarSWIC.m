...
%  sites, or two beams from one VHF/HF radar site, identifies its 2nd order
%  continuum and inverts it to create an ocean wave spectrum.
%
%  For more details see:
%
%  Al-Attabi, Z., Voulgaris G., and Conley D.,(2021):Evaluation and Validation of
%  HF Radar Swell and Wind wave Inversion, Journal of
%  Oceanic and Atmopsheric Technology, xx: yyyy-yy
%
% The function:
%
...
%     with width sigma uisng Hs, fs, ths from lipa's inversion method
%  5. Reconstruct total wave spectrum Sf = Sfs+Sfw
%  6. Estimate the 2D directioanl wave spectrum
%
...
%% Uses
%  wn2ndRSWIC.m; specWindRSWIC.m; dopLipaS.m; swell_param_singularities.m;
%  specSwellRSWIC.m wspecRSWIC_hybrid.m waveparamter_separated_v3.m
