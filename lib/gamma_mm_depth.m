...
% function [G,C,f] = gamma_mm(m1,m2,k0,k1,th1) 
...
% by th1 (in degrees). 
%
% m1 and m2 are the positive and negative Bragg peaks(m1) and left or right of the 
% Bragg peak (m2)
...
% approximantion, see appendix in Wang et al. 2016 or Lipa and Barrick 1980
...
% ks, % does ths change with Bragg peak?
k1x = ks*cosd(ths);
k1y = ks*sind(ths);
...
% calculate k2, wind wave that scatters with the k1, swell wave
% radar k
k0x = k0; %k0*cosd(th0);
if m1 < 0
    k0x = - k0x;
