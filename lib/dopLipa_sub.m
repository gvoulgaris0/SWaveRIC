...
debug.SNR2_n   = max(max([E1x,E2i]))./Noisex;
debug.SNR1_n   = max(S1Npeak)./Noisex;
...
debug.SNR2_p   = max(max([E3i,E4x]))./Noisex;
debug.SNR1_p   = max(S1Ppeak)./Noisex;
